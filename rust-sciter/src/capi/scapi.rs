...
pub struct ISciterAPI
{
  ...
  // since 4.0.0.0
	...
	// Entries below are 4.4.2+ only — NOT present in Sciter 4.2.x.
	// For XP compatibility with older Sciter DLLs, these are kept as usize
	// (Send+Sync safe) so the struct can be safely truncated without UB.
	// Code must check api_version() before calling any of these.
	pub _slot_SciterAtomValue: usize,
	pub _slot_SciterAtomNameCB: usize,
	pub _slot_SciterSetGlobalAsset: usize,
	pub _slot_SciterGetElementAsset: usize,
	pub _slot_SciterSetVariable: usize,
	pub _slot_SciterGetVariable: usize,
	pub _slot_SciterElementUnwrap: usize,
	pub _slot_SciterElementWrap: usize,
	pub _slot_SciterNodeUnwrap: usize,
	pub _slot_SciterNodeWrap: usize,
